...
{    
    ...
    m_pAppNameLab->setText("SyncProxyTester");;
    // SetAppName

    QHBoxLayout *pCenterLayout = new QHBoxLayout;
    QHBoxLayout *pCenterCenterLayout = new QHBoxLayout;
    pCenterLayout->addLayout(pCenterCenterLayout);
    pCenterLayout->setAlignment(pCenterCenterLayout,Qt::AlignCenter);
    m_pIconLab = new QLabel;
    m_pMainTitleLab = new QLabel;
    pCenterCenterLayout->addWidget(m_pIconLab,0,Qt::AlignLeft);
    pCenterCenterLayout->addWidget(m_pMainTitleLab,0,Qt::AlignLeft);
    ...
    //m_pListWidget = new CustomCombobox(0,height(),width(),height(),true,this);
}
